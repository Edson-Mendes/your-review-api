...
class ReviewRepositoryIT {
  ...
  class findProjectedByMovieVotesMovieIdMethod {
    ...
    void findProjectedByMovieVotesMovieId_MustReturnPageReviewSummaryProjectionWith1Element_WhenFoundSuccessfully() {
      ...
      assertThat(actualReviewSummaryProjection.getUserName()).isNotNull().isEqualTo("John Doe");
      assertThat(actualReviewSummaryProjection.getUserEmail()).isNotNull().isEqualTo("john.doe@email.com");
